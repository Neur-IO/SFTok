...
WANDB_MODE=offline PYTHONPATH=./ HF_ENDPOINT=https://hf-mirror.com /path/to/accelerate launch \
    ...
    --same_network scripts/train_sftok.py config=configs/sftok_b64_stage3.yaml \
    experiment.project=sftok-b_stage3 \
    ...
    experiment.init_weight=/path/to/stage2-checkpoint/ema_model/pytorch_model.bin
