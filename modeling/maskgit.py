...
class ImageBert(BaseModel, PyTorchModelHubMixin, tags=["arxiv:2406.07550", "image-generation"], repo_url=None, license="apache-2.0"):
    def __init__(self, config):
        ...
        self.condition_num_classes = config.model.img_generator.condition_num_classes
        self.image_seq_len = config.model.img_generator.image_seq_len
        self.mask_token_id = self.target_codebook_size
        self.hidden_size = config.model.img_generator.hidden_size
        self.num_hidden_layers = config.model.img_generator.num_hidden_layers
        self.num_attention_heads = config.model.img_generator.num_attention_heads
        self.intermediate_size = config.model.img_generator.intermediate_size
        ...
        self.model = BertModel(BertConfig(
            ...
            hidden_act='gelu',
            hidden_dropout_prob=config.model.img_generator.dropout,
            attention_probs_dropout_prob=config.model.img_generator.attn_drop,
            max_position_embeddings=config.model.img_generator.image_seq_len + 1,
        ...
        # self.model.lm_head = nn.Linear(self.hidden_size, 8192, bias=True)
    ...
    def forward(self, input_ids=None, condition=None, cond_drop_prob=0.1):
        ...
        res = self.model.lm_head(model_output[:, 1:])
        return res # remove cond
