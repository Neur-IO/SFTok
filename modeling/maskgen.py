...
class MaskGen_VQ(BaseModel, PyTorchModelHubMixin, tags=["arxiv:2501.07730", "text-to-image-generation"], repo_url=None, license="apache-2.0"):
...
class MaskGen_KL(BaseModel, PyTorchModelHubMixin, tags=["arxiv:2501.07730", "text-to-image-generation"], repo_url=None, license="apache-2.0"):
    """ MaskGen-KL Variant
    """
    def __init__(self, config):
        if isinstance(config, dict):
